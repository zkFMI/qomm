...
use zkpi_committee::node_service::certificate_fingerprint;
...
pub struct WanDeploymentSpec {
    ...
    pub recipient_opening_keys: Vec<zkpi_committee::proof_party::RecipientOpeningKey>,
    pub n_mm: usize,
    pub n_parties: usize,
...
fn decode_kyb(
    ...
    (
        SignedCohortRegistry,
        KybPresentation,
        zkpi_proofs::kyb::KybIssuerKey,
    ),
    String,
> {
    let issuer = zkpi_proofs::kyb::KybIssuerKey::from_bytes(
    ...
    let registry_issuer = zkpi_proofs::kyb::KybIssuerKey::from_bytes(
