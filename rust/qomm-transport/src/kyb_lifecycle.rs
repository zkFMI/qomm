...
use zkpi_proofs::kyb::{verify_registry, BusinessAttributes, KybCredential, SignedCohortRegistry};
...
impl StoredRegistry {
    ...
    fn registry(&self) -> Result<SignedCohortRegistry, String> {
        ...
        Ok(SignedCohortRegistry {
            ...
            issuer: zkpi_proofs::kyb::KybIssuerKey::from_bytes(&issuer)
    ...
    pub fn latest_registry(
        ...
        state
            ...
            .map(|registry| {
                verify_registry(
                    &registry,
                    &zkpi_proofs::kyb::KybIssuerKey::from_bytes(&self.signing.public_key())
                        .map_err(str::to_string)?,
                    now,
                )
